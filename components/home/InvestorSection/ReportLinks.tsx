  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 md:gap-[10px] items-center -mt-10 md:mt-0 lg:gap-4 lg:mt-1">
      ...
      <a
        ...
        className="flex items-center justify-center gap-2  text-[16px] leading-[150%] bg-surface-3 hover:bg-surface-2 active:bg-button-secondary-active rounded-[12px] py-3  px-8  text-center w-[279px] md:w-[217px]  font-open-sans"
        target="_blank"
        download
      >
