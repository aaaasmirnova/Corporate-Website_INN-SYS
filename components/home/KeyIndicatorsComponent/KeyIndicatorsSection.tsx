...
export const KeyIndicatorsSection = () => {
  return (
    ...
    >
      <h1 className="font-heading font-semibold bg-radial from-neutral-bright-beginning to-neutral-grey-300 bg-clip-text text-transparent text-[24px] md:text-[32px] xl:text-[40px]">Ключевые показатели</h1>
