...
export const Career = () => {
  ...
  return (
    <section className="container  flex flex-col items-center">
      <h1 className="gradient-custom-career-hero text-[24px] leading-[150%] md:text-[40px] lg:text-[64px] lg:leading-18 font-semibold w-75 md:w-192 lg:w-320 mb-4 lg:mb-10 text-center">
        {t("CareerHero.title")}
      </h1>
