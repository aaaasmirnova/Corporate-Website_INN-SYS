...
export default function ContactsForm() {
  ...
  return (
    <section className="bg-neutral-black-elbrus">
      <div className="max-w-214 w-full mx-auto px-5 text-white">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-wrap gap-4 mb-4 md:gap-6 md:mb-6">
            <div className="w-full md:w-[calc(50%-12px)]">
              <input
                type="text"
                placeholder="Имя"
                className="w-full h-12 px-4 border border-accent-5 rounded-xl focus:border-white placeholder:text-accent-6 "
          ...
          {/* File Upload */}
          <div>
            <label className="flex flex-col items-center justify-center h-24 mb-6 px-4 border border-dashed border-accent-5 rounded-xl cursor-pointer">
              <p className="text-accent-6">
                {selectedFile ? (
                  ...
                  <>
                    <span className="hidden md:inline">Перенесите файл сюда или</span>{" "}
          ...
          <div className="mb-20 md:mb-28">
            <label className="flex items-center gap-3 mb-5 md:mb-12">
            ...
            <button
              type="submit"
              className="block h-12 mx-auto px-8 bg-button-primary text-neutral-black-elbrus rounded-xl cursor-pointer md:min-w-64"
