...
export const ExpertiseTabNornikel = () => {
  ...
  return (
    <div className="-mx-6 lg:mx-auto">
      <h2 className="max-w-82 mx-auto px-2 text-[18px] font-semibold text-transparent bg-title-gradient bg-clip-text text-center sm:max-w-124 sm:text-2xl lg:max-w-200 lg:text-[40px]">
        {t("info_tab_1.title")}
      </h2>
      <div className="relative flex flex-col pt-31 pb-39.5 sm:pt-20 lg:pt-37.5">
        ...
        />
        <Image
          src="/images/expertise/nornikel-bg-desktop.svg"
          alt="nornikel"
          fill
        ...
        <div className="relative flex flex-col gap-2 text-white z-10 lg:flex-row lg:flex-wrap">
          <div className="flex flex-col gap-2 lg:max-w-148.5 lg:w-[41%]">
            ...
            <div className="p-px rounded-3xl bg-[linear-gradient(258.1deg,#26C7FF_-4.47%,#FF4D5D_85.07%,#0F4D81_102.14%)]">
              <div className="px-8 py-8 rounded-3xl bg-black sm:py-10 lg:px-9">
                <Image
                  src="/images/expertise/cube.png"
                  alt="nornikel"
                  width={400}
                  height={400}
                  className="max-w-100 mx-auto object-contain"
                />
              </div>
            </div>
          </div>
