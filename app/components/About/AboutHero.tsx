...
export const AboutHero = () => {
  ...
  return (
    <section className="container relative w-full h-[536px] md:h-[602px] lg:h-[1176px] flex flex-col mb-29 md:mb-7.25 lg:mb-13.75 bg-[url('/images/AboutHeroDesktop.png')] bg-cover bg-center bg-no-repeat">
